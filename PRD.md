...
| URL or text input | `/fact-check` and the CLI accept a bounded claim, pasted text, one or more public URLs, or both |
...
1. Creator submits statement, criteria, evidence policy, claim mode, timing, and reward budget. The public fact-check interface accepts pasted text, one or more public URLs, or both.
