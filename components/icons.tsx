...
export const Code = icon(Iconsax.Code, "Code");
...
export const MessageProgramming = icon(Iconsax.MessageProgramming, "MessageProgramming");
export const MoneyRecive = icon(Iconsax.MoneyRecive, "MoneyRecive");
export const Pause = icon(Iconsax.Pause, "Pause");
export const People = icon(Iconsax.People, "People");
export const Play = icon(Iconsax.Play, "Play");
