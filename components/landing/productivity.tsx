      ...
      <div className="relative px-5 pt-24 pb-24 md:px-7 md:pt-28 md:pb-28">
        <div className="grid gap-8 lg:grid-cols-3 lg:gap-7">
          ...
          <div className="relative z-30 flex flex-col justify-between">
            ...
            >
              Five jurors across three model families, every inference on
              GonkaRouter, research both sides, deliberate under commit–reveal,
              and the tally settles on-chain. Every score is integer arithmetic
              anyone can rerun against the same recorded evidence and research
              trails.
            </p>
          </div>
