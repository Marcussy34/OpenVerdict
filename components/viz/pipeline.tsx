...
export const PIPELINE_STAGES: Stage[] = [
  {
    ...
    kicker: "Retrieval",
    title: "Claim frozen",
    body: "Your statement is hashed, stored on Walrus and registered on Sui before any juror sees it.",
    icon: DocumentText,
    tone: "chain",
  },
  {
    index: "02",
    kicker: "Inference",
    title: "Five-juror research",
    body: "Five seats across three model families (DeepSeek, Kimi, MiniMax) search the open web for and against the claim; every query and page is recorded in a sealed bundle.",
    icon: Cpu,
    tone: "primary",
  },
  {
