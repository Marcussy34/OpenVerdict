...
export const PIPELINE_STAGES: Stage[] = [
  {
    ...
    kicker: "Retrieval",
    title: "Claim frozen",
    body: "Hashed, stored on Walrus and registered on Sui before any juror sees it.",
    icon: DocumentText,
    tone: "chain",
  },
  {
    ...
    body: "Five jurors across three model families search the web for and against; every step lands in a sealed bundle.",
    icon: Cpu,
    tone: "primary",
  },
  {
  ...
  },
  {
    ...
    body: "A supermajority mints the certificate with its Truth Score.",
    icon: ShieldTick,
    tone: "yes",
  },
];
