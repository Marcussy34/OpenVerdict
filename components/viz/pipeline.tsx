...
export const PIPELINE_STAGES: Stage[] = [
  {
    ...
    body: "Public URLs and pasted text are fetched through SSRF-safe crawlers, canonicalised, and frozen into an immutable Walrus Merkle root.",
    icon: DocumentText,
    tone: "chain",
  },
  {
    ...
    body: "Five seats across ≥3 distinct model families (DeepSeek, Kimi, MiniMax) review the frozen bundle independently through GonkaRouter.",
    icon: Cpu,
    tone: "primary",
  },
  {
    ...
    body: "Each juror posts an on-chain commitment over its vote preimage. Nothing is readable, so nothing can be front-run or copied.",
    icon: Lock,
    tone: "sealed",
  },
  {
    ...
    body: "Votes, confidences and structured reasoning traces open on Sui and are verified byte-for-byte against the sealed preimage.",
    icon: Unlock,
    tone: "chain",
  },
  {
    ...
    body: "A 4-of-5 supermajority mints a ResolutionCertificate carrying a deterministic Truth Score, and releases the payout.",
    icon: ShieldTick,
    tone: "yes",
  },
];
