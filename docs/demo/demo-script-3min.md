...
4. https://app.openverdict.info/claims/0x1d53f02c823ba5ee1c1aa3a22ff862306d2ab22c67247f39746db65f6ea76ff4 (the two-round claim "Intermittent fasting produces greater long-term weight loss than continuous daily calorie restriction.", round one split, six-turn debate, sealed table vote, UNRESOLVED, 21 / 100)
5. https://app.openverdict.info/claims/0xd86526512ffcc78c3460064b46b56252d5d2d3adc69aedc24ad9c8325c81ac8c/report (the report of "Bitcoin's total supply is capped at 21 million coins.", YES, 97 / 100, settled on attempt 2 of 3 after a voided attempt)
6. https://app.openverdict.info/verify (Audit)

Claim to submit live: `Sui mainnet launched on 3 May 2023.` (bounded, dated, checkable; the jury settles it YES). The EU AI Act claim is a good spare.
...
Tab 4 is the debate claim on purpose: the round-two conversation is the strongest thirty seconds of the demo. Its transcript is the earlier style, each juror stating its position in turn; say "they argue over the frozen record, no new evidence may enter" and let the turns speak.
...
| 0:30 | Tab 4, the debate claim. Press Play at 10x, then 30x. | "Watch the replay. The committee is drawn. Each juror searches for and against, opens pages, quotes them, and seals its vote as a blake2b commitment on Sui. Nobody, not even the operator, can read a vote until every seat has sealed." |
| 0:50 | Replay reaches the reveals. | "Then the reveals. Sui recomputes every commitment before it accepts one. Four matching votes settle a claim. This jury split, three NO and two seats silent, so the protocol opened a public debate over the frozen record, then a sealed table vote." |
| 1:05 | Chat view: scroll the juror cards, open one trail, then scroll to the debate. | "This is the conversation view: every search, every page, every quote, per juror. Under it the debate, six turns where the jurors argue over the frozen record and no new evidence may enter." |
...
| 1:20 | Click the certificate node. | "The resolution certificate on Sui: UNRESOLVED, truth score 21 out of 100. The table vote never reached four matching votes, and the chain says so instead of guessing." |
...
| 1:45 | Tab 5, the Bitcoin report. Point at the attempts line, open Full view, scroll once. | "The report. This claim took two attempts: the first was voided when a juror's answer failed the schema, and every void stays public. The full view is every step, every hash, every run proof." |
...
- Why two attempts on the Bitcoin claim: a seat failed closed on a malformed answer, the attempt was voided and relaunched on the next clear weather probe, and both attempts are on the report and on the board.
- Why UNRESOLVED is a verdict: the jury needs four matching votes of five; when the sealed table vote after the debate still falls short, the certificate says UNRESOLVED with the mean probability as its truth score, and nobody gets to pick a side for it.
